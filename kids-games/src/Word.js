...
function Word(props){
    ...
    return <div>
                <WordElement new_word={list_of_word_out[0]} letter={list_of_letter_out[0]}/>
                <WordElement new_word={list_of_word_out[1]} letter={list_of_letter_out[1]}/>
                <WordElement new_word={list_of_word_out[2]} letter={list_of_letter_out[2]}/>
           </div>
