  ...
  return (
    <div className="component-number">
      <div className="component-number--value">
        <diV>{numberOne > numberTwo ? numberOne : numberTwo}</diV>
        <div className="little">{numberOne > numberTwo ? strOne : strTwo}</div>
      </div>
      <div className="component-number--value">{randomOperator}</div>
      <div className="component-number--value">
        <diV>{numberOne < numberTwo ? numberOne : numberTwo}</diV>
        <div className="little">{numberOne < numberTwo ? strOne : strTwo}</div>
      </div>
      <div className="component-number--value">=</div>
    </div>
  );
}
